...
function template_init()
{
	...
	$settings['theme_variants'] = array('blue', 'light_blue','green_lavender','dark_orange');
}
...
<head>';
	...
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/scroll.js"></script>
...
function template_body_above()
{
	...
	<div id="the_user_menu"><div id="the_user_menu-wrap">';
		...
		echo '
		<div class="floatleft">';
			// Display home & search icon
			echo '
			<ul class="the_user_menu_box">
				<li><a href="'.$scripturl.'" title="', $txt['theme_home_icon'], '"><img src="' . $settings['images_url'] . '/theme_custom/home.png" alt="', $txt['home'], '" /></a></li>
				<li><img src="' . $settings['images_url'] . '/theme_custom/search.png" alt="', $txt['theme_search'], '" />
					<ul>
								<li><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
		...
		// If user is guest (i.e. user is not logged in), display guest greeting & login icon
		if (!($context['user']['is_logged']))
		{
		echo '
		<div class="floatleft">
			<ul class="the_user_menu_box">
				<li><img src="' . $settings['images_url'] . '/theme_custom/login.png" alt="', $txt['theme_login'], '" />
					<ul><li>
		...
		<div class="floatleft">
			<ul class="the_user_menu_dropdown">
				<li>', $txt['hello_member_ndt'] ,' ', $context['user']['name'] ,'
					<ul class="the_user_menu_dropdown">
						<li>', $txt['theme_color'] ,'</li>
						<li><a href="', $scripturl, '?variant=blue">', $txt['theme_color_blue'], '</a></li>
						<li><a href="', $scripturl, '?variant=light_blue">', $txt['theme_color_light_blue'], '</a></li>
						<li><a href="', $scripturl, '?variant=green_lavender">', $txt['theme_color_green_lavender'], '</a></li>
						<li><a href="', $scripturl, '?variant=dark_orange">', $txt['theme_color_dark_orange'], '</a></li>
					</ul>
				</li>
			</ul>
		</div>';
		...
		<div class="floatleft">
			<ul class="the_user_menu_box">
				...
				<li><a href="'. $scripturl. '?action=logout;', $context['session_var'], '=', $context['session_id'], '" title="Logout"><img src="' . $settings['images_url'] . '/theme_custom/logout.png" alt="', $txt['theme_logout'], '" /></a></li>';
				
				// Is the forum in maintenance mode?
				if ($context['in_maintenance'] && $context['user']['is_admin'])
					echo '
				<li><img src="' . $settings['images_url'] . '/theme_custom/warning.png" alt="', $txt['theme_warning'], '" />
					<ul>
						<li>', $txt['maintain_mode_on'], '</li>
					</ul>
				</li>';
				...
				if (!empty($context['unapproved_members']))
					echo '
				<li><img src="' . $settings['images_url'] . '/theme_custom/info.png" alt="', $txt['theme_info'], '" />
					<ul>
...
<div id="main_menu_area-wrap">
	<div id="main_menu_area">',template_menu(),'</div>
</div>';
...
<div id="footer-wrap">
	<div id="footer">
		<div class="floatright">
			<ul>
				<li><br /></li>
				<li>', $txt['theme_desc'] ,'</li>
				<li><br /><br /><br /></li>
				<li>', theme_copyright(), '</li>
				<li><a id="button_xhtml" href="http://validator.w3.org/check?uri=referer" target="_blank" class="new_win" title="', $txt['valid_xhtml'], '"><span>', $txt['xhtml'], '</span></a>
		...
		<div class="floatleft">
			<ul>';
			if(!empty($settings['footer_id_1']) && !empty($settings['footer_url_1']))
				echo '
					<li><a href="', $settings['footer_url_1'] , '" target="_blank">', $settings['footer_id_1'] , '</a></li>';
			if(!empty($settings['footer_id_2']) && !empty($settings['footer_url_2']))
				echo '
					<li><a href="', $settings['footer_url_2'] , '" target="_blank">', $settings['footer_id_2'] , '</a></li>';
			else
				echo '
					<li><br /></li>';
			if(!empty($settings['footer_id_3']) && !empty($settings['footer_url_3']))
				echo '
					<li><a href="', $settings['footer_url_3'] , '" target="_blank">', $settings['footer_id_3'] , '</a></li>';
			else
				echo '
					<li><br /></li>';
			if(!empty($settings['footer_id_4']) && !empty($settings['footer_url_4']))
				echo '
					<li><a href="', $settings['footer_url_4'] , '" target="_blank">', $settings['footer_id_4'] , '</a></li>';
			else
				echo '
					<li><br /></li>';
			if(!empty($settings['custom_copyright'])) {
				echo '
					<li>', $settings['custom_copyright'] , '</li>
					<li>', $context['forum_name'], ' &copy; ' . date("Y", time()) . ' | ', $txt['rights_reserved'], '</li>
					<li><br /></li>';
			}
			else {
				echo '
